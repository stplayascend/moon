...
module.exports = createCatalogFlow({
  flowPrefix: 'dd',
  dataKey: 'dragDriveSimulator',
  productName: 'Drag Drive Simulator',
  priceListTitle: '🏍️ Drag Drive Simulator - Price List',
  usernameModalTitle: '🏍️ Drag Drive Simulator - Order',
  instructionText:
`📌** Instruksi:**
